  ...
  return (
    <div className={styles.about}>
      <div className={styles.container}>
        ...
        <div className={`row`}>
          <div
            className={`col-lg-3 ${styles.imageContainer}`}
            data-aos="fade-right"
          >
            <Image
              src={brain}
          ...
          <div
            className={`col-lg-9 pt-4 pt-lg-0 ${styles.content}`}
            data-aos="fade-left"
          >
            ...
            <p className={styles.paragraph}>
              <strong className={styles.strong}>Note:</strong> I'm available to
              work Remote and Hybrid. I am also available to work physically and
              relocate regardless of location.
            </p>
          </div>
        </div>
      </div>
